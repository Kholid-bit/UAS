<?php include_once "cekpembayaran.php" ;?>
  ...
  <table class="table table-striped table-bordered table-hover">
    ...
    <tbody>
      ...
      if($kolomCari=="" && $kolomKataKunci==""){
        $SqlQuery = mysqli_query($con, "SELECT * FROM mahasiswa LIMIT ".$limitStart.",".$limit);
      }else{
        //kondisi jika parameter kolom pencarian diisi
        $SqlQuery = mysqli_query($con, "SELECT * FROM mahasiswa WHERE $kolomCari LIKE '%$kolomKataKunci%' LIMIT ".$limitStart.",".$limit);
      }
  ...
  <div align="right">
    <ul class="pagination">
      ...
      <?php
        //kondisi jika parameter pencarian kosong
        if($kolomCari=="" && $kolomKataKunci==""){
          $SqlQuery = mysqli_query($con, "SELECT * FROM mahasiswa");
        }else{
          //kondisi jika parameter kolom pencarian diisi
          $SqlQuery = mysqli_query($con, "SELECT * FROM mahasiswa WHERE $kolomCari LIKE '%$kolomKataKunci%'");
        }     
